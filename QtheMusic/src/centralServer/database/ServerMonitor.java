...
public class ServerMonitor {
	 ...
	 * @return an int representing an id if success or NO_AVAILABLE_ID if unsuccessful
	 * 
	 */
	 ...
	 * @param hostId of the host wanting to terminate the connection.
	 * @throws InvalidHostIDException if the hostId has already been disconnected
	 */
